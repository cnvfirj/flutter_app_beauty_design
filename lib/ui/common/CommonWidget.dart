...
//       provider.observer(anim, widget._id);
...
//                 provider.write(_key('first'), widget._recovery.first);
//                 provider.write(_key('second'), widget._recovery.second);
//               });
//             },
//             child: _clipChild(),
...
//                       },
//                       onPanEnd: (d) {
//                         provider.write(_key('first'), widget._position.first);
//                         provider.write(_key('second'), widget._position.second);
//                       },
...
class StateWidgetTranslate extends State<WidgetTranslate> {
  ...
  String _key() {
    return 'WidgetTranslatePosition${widget._id.toString()}';
  }
}
